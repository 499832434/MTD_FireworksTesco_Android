package com.chem99.fireworkstesco.view;
...
public class CustomTitleBar extends LinearLayout {
    ...
    public CustomTitleBar(Context context, AttributeSet attrs) {
        ...
        addView(titleBar, new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT));
    }
